# test-build-hygiene Specification

## Purpose

Specification for the `test-build-hygiene` capability, established by the `address-r1-findings` change. Covers R1-18, R1-52…54, R1-74, R1-75.
